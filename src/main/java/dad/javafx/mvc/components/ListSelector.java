...
public class ListSelector<T> extends GridPane implements Initializable {
	...
	@FXML
	private Button moveLeftButton, movelAllLeftButton, movelAllRightButton, moveRightButton;
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		movelAllLeftButton.disableProperty().bind(Bindings.isEmpty(rightItems));
		movelAllRightButton.disableProperty().bind(Bindings.isEmpty(leftItems));
